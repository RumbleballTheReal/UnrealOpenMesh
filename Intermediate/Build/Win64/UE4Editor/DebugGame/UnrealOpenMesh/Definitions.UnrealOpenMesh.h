...
#define ORIGINAL_FILE_NAME "UE4Editor-UnrealOpenMesh-Win64-DebugGame.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 1
#define UE_PROJECT_NAME ThePaintProject
#define DEPRECATED_FORGAME DEPRECATED
#define UNREALOPENMESH_API DLLEXPORT
